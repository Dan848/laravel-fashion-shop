...
@section('content')
    <div class="container">
        <a class="btn btn-create mx-auto m-4 btn-sm" href="{{ route('admin.products.create') }}">Aggiungi un
            tuo
            prodotto!</a>
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td>
                            <div class="img-preview"><img class="img-fluid" src="{{ $product->image_link }}" alt="">
                            </div>
                        </td>
                        @php
